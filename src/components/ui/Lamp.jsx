...
//           ease: "easeInOut",
//         }}
//         className="mt-8 bg-gradient-to-br from-blue-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl">
